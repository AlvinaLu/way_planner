...
enum class GeocodingStatus(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is GeocodingStatus) "$data" else null

        /**
         * Returns a valid [GeocodingStatus] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): GeocodingStatus? = data?.let {
