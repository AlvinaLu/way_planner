...
import org.openapi.google.model.Elevation200ResponseResultsInner
...
data class Elevation200Response (

    @field:JsonProperty("status")
    val status: ElevationStatus,

    @field:JsonProperty("results")
    val results: kotlin.collections.List<Elevation200ResponseResultsInner>,
