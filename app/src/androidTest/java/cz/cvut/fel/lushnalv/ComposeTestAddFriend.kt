...
class ComposeTestAddFriend {
    ...
    fun addFriendTest() {
      ...
      ///
        ...
        composeTestRule.onNodeWithTag("Team").performClick()
        ...
        composeTestRule.apply {
            onNodeWithTag( "login_email_tag").performTextInput("test17@gmail.com")
            onNodeWithTag("trip_info_add_friend_dialog_button_tag").performClick()
        }
        composeTestRule.waitUntil(10000) {
            composeTestRule
                .onAllNodesWithText("test17")
                .fetchSemanticsNodes().size == 1
        }
        composeTestRule.onNodeWithText("test17").assertIsDisplayed()
